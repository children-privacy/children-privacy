...
function getParsedCluster (categoryObject, collection) {
  ...
  // console.log("c.collectionPaths[collection]: " + c.collectionPaths[collection]);
  ...
  // console.log(categoryClusterURL);
...
function parseCategoryApps (categoryObject, opts) {
  ...
  var clusterUrl = "/store/apps/new?";
  
  // console.log(categoryObject);

  if(collection == 'topselling_new_family'){
    clusterUrl = '/store/apps/new/category/FAMILY?'
  }
  else if(collection != 'topselling_new_free' && collection != 'topselling_new_paid'){
  ...
  // console.log(clusterUrlToProcess);
